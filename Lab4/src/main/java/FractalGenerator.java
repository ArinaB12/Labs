...
public abstract class FractalGenerator {
     ...
     *  преобразует её значение двойной точности, соответствующее определенному диапазону.
    ...
    /**
     * Задает указанный прямоугольник, содержащий начальный диапазон, подходящий для создаваемого фрактала.*/
