...
import paket.CrawlerTask;
import paket.URLPool;
...
public class Crawler {
    ...
    public static void main(String[] args) {
        String[] arg = new String[]{"http://kremlin.ru/","2", "3"};
        ...
        else System.out.println("usage: java paket.Crawler <URL> <maximum_depth> <num_threads>");
    }
}